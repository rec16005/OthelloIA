...
def on_ready(data):
    ...
    movement = " "
    emptys = v.getEmptys(data['board'])
    adys = v.getAdys(data['board'], emptys, data['player_turn_id'])
    flanks = v.getFlanks(data['board'], adys, data['player_turn_id'])
    movement = r.choice(flanks)
